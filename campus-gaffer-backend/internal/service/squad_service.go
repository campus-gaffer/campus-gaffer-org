...
const (
	// OnFieldCount is the number of starters in a squad.
	OnFieldCount = 6
	// BenchCount is the number of bench players (0 = no bench).
	BenchCount = 0
...
var (
	...
	ErrWrongBenchCount   = errors.New("squad must have exactly 0 bench players")
